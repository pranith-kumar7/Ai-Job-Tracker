...
const applicationsQueryKey = ["applications"];
const themeStorageKey = "job-tracker-theme";

const activeReminderStatuses = [
  "Applied",
  "Phone Screen",
  "Interview",
];

const isOverdueApplication = (application) => {
...
export default function Dashboard() {
  ...
  const statusMutation = useMutation({
    ...
    onMutate: async ({ id, status }) => {
      ...
      queryClient.setQueryData(applicationsQueryKey, (current) =>
  ...
  const handleSaveApplication = async (payload, applicationId) => {
    setBoardError(null);
  ...
  const handleDropApplication = async (status) => {
  ...
  return (
    <div className="dashboard-shell">
      ...
      <ApplicationModal
        ...
        parseJobDescription={(jdText) => aiApi.parseJobDescription(jdText)}
        generateResumeSuggestions={(payload) => aiApi.generateResumeSuggestions(payload)}
        streamResumeSuggestions={(payload, onChunk) =>
          aiApi.generateResumeSuggestionsStream(payload, onChunk)
        }
      />
    </div>
  );
